...
- **[EcoIndex](https://www.ecoindex.fr/)** : Outil d'analyse de l'impact environnemental des pages web.
- **[Website Carbon](https://www.websitecarbon.com/)** : Test pour mesurer l'empreinte carbone d'un site web.
- **[Green Code Initiative](https://green-code-initiative.org/)** : Initiative pour un développement numérique plus écologique.
- **[Sustainable Web Design](https://sustainablewebdesign.org/)** : Guide pour concevoir des sites web plus durables.
- **[Low-Tech Magazine](https://www.lowtechmagazine.com/)** : Ressources sur la conception numérique à faible impact environnemental.
- **[The Green Web Foundation](https://www.thegreenwebfoundation.org/)** : Outil pour vérifier si un site utilise de l'énergie verte.
